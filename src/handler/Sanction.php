...
class Sanction
{
    ...
    public static function banPlayer(string $player, string $target, string $sanction, int $time): void
    {
        ...
        Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Le joueur §c" . $target . " §fa été banni pendant §c" . $format . "§f par §c" . $player . "§f, raison: §c" . $sanction);
    ...
    private static function mutePlayer(Player $player, string $target, string $sanction, int $time): void
    {
        ...
        $targetPlayer->sendMessage(Util::PREFIX . "Vous avez été mute pendant §c" . $format . "§f, par §c" . $player->getName() . "§f, raison: §c" . $sanction);

        Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Le joueur §c" . $targetPlayer->getName() . " §fa été mute pendant §c" . $format . " §fpar §c" . $player->getName() . "§f, raison: §c" . $sanction);
