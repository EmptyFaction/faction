    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        switch (mt_rand(1, 3)) {
            case 1:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le première à réécrire le code pour gagner §c5k$ §f! Code: §c" . $code);
            ...
            case 2:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le première à trouver le bon mot pour gagner §c5k$ §f! Mot: §c" . str_shuffle($word));
            ...
            case 3:
                ...
                Main::getInstance()->getServer()->broadcastMessage(Util::PREFIX . "Soyez le première à répondre au calcul pour gagner §c5k$ §f! Calcul: §c" . $number1 . " " . $method . " " . $number2);
